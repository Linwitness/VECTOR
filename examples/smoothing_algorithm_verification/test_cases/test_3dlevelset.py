...
# -*- coding: utf-8 -*-
"""
Test suite for 3D Level Set smoothing algorithm implementation.
...
import myInput
from PACKAGE_MP_3DLevelSet import levelSet3d_class
...
def test_sphere():
    ...
    alg_params = ALGORITHM_PARAMS['3dlevelset']
    ...
    levelset3d = levelSet3d_class(nx, ny, nz, ng, cores, nsteps, P0, R,
    ...
    levelset3d.levelSet3d_main(purpose="inclination")
    P = levelset3d.get_P()
    gb_sites = levelset3d.get_gb_list()
    ...
    print(f"Normal vector calculation time: {levelset3d.running_time:.2f}s")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, 'levelset3d_sphere_test.png'))
    plt.close()
...
def test_convergence():
    ...
    for nsteps in step_range:
        ...
        times.append(levelset3d.running_time)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, 'levelset3d_convergence_test.png'))
    plt.close()

if __name__ == '__main__':
    print("Running 3D Level Set smoothing algorithm tests...")
