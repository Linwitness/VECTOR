...
if __name__ == '__main__':
    ...
    input_name = "input/primme_sz(512x512)_ng(512)_nsteps(1600)_freq(1)_kt(0.66)_cut(0).h5"
    ...
    #%% Start the algorithms
        ...
        cores = 8
        loop_times = 5
        test1 = smooth.linear_class(nx, ny, ng, cores, loop_times, microstructure, R)
