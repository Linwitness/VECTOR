...
if __name__ == '__main__':
    ...
    dump_file_foler = "/Users/lin/projects/VECTOR/examples/dump_to_init/"
    init_file_folder = dump_file_foler + "IC/"

    # High-performance storage for output (faster I/O)
    init_file_folder_final = "/Users/lin/projects/VECTOR/examples/dump_to_init/IC/"

    # Target files for processing
    init_file_name = f"VoronoiIC_257_257.init"                    # Input: 1000^3 domain, 20K grains
    init_file_name_final = f"VoronoiIC_257_257_neighbor5.init"    # Output: With neighbor connectivity
    ...
    box_size = np.array([257, 257, 1]).astype('int')
    size_x, size_y, size_z = box_size
    total_sites = size_x * size_y * size_z
