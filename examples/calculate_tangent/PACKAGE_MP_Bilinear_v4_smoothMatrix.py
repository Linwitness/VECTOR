...
if __name__ == '__main__':
    BL_errors2 =np.zeros(10)
    BL_runningTime2 = np.zeros(10)
    ...
    for cores in [1]:
        ...
        for loop_times in range(3,4):
            ...
            BL_errors2[loop_times-1] = test1.errors_per_site
            BL_runningTime2[loop_times-1] = test1.running_coreTime
