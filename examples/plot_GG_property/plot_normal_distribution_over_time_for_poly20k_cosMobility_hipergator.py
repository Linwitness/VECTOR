...
# -*- coding: utf-8 -*-
"""
Backward compatibility wrapper for cosine mobility analysis on HiPerGator.
...
if __name__ == '__main__':
    # Custom configuration for cosine mobility analysis
    config = {
        ...
        'cases': {
            'iso': {'file': 'p_aveE_20000_Cos_delta0.0_J1_refer_1_0_0_seed56689_kt0.66.npy',
                    'label': 'Iso', 'step': 'auto'},
            '070': {'file': 'p_aveE_20000_CosMax1Mobility_delta0.7_J1_refer_1_0_0_seed56689_kt0.66.npy',
                    'label': r'$\sigma$=0.7', 'step': 'auto'},
            '080': {'file': 'p_aveE_20000_CosMax1Mobility_delta0.8_J1_refer_1_0_0_seed56689_kt0.66.npy',
                    'label': r'$\sigma$=0.8', 'step': 'auto'},
            '090': {'file': 'p_aveE_20000_CosMax1Mobility_delta0.9_J1_refer_1_0_0_seed56689_kt0.66.npy',
                    'label': r'$\sigma$=0.9', 'step': 'auto'},
        }
    }
    analyzer = NormalDistributionAnalyzer(geometry='poly2d', environment='hipergator', config=config)
    analyzer.run(output_prefix='normal_distribution_cosMobility', bias_case='iso')
