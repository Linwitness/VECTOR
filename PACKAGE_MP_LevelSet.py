...
class levelSet_class(object):
    ...
    def levelSet_normal_vector_core(self,core_input, core_all_queue):
    ...
    def levelSet_main(self):
        ...
        for ki in range(main_wc):
            for kj in range(main_lc):
                res_one = pool.apply_async(func = self.levelSet_normal_vector_core, args = (multi_input[ki][kj], all_queue, ), callback=self.res_back )
