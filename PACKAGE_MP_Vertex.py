        ...
        # calculate time
            ...
            for ki in range(main_wc):
                for kj in range(main_lc):
                    ...
                    res_one = pool.apply_async(func = self.VTv2_core, args = (multi_input[ki][kj], ), callback=self.res_back )
...
if __name__ == '__main__':
    ...
    for ci in cores:
        for inti in interval:
            test1 = VTv2_class(nx,ny,ng,ci,inti,P0,R)
            test1.VTv2_main()
            P = test1.get_P()
